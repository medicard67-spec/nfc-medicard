...
export default function PatientRadiology() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-xl font-bold text-slate-800 dark:text-slate-100">Radiology Visualization Gallery</h1>

      {loading && <SkeletonList rows={2} />}

      {!loading && images.length === 0 && (
        <EmptyState icon="🩻" title="No imaging records yet" subtitle="X-rays, MRIs, and CT scans uploaded by your doctor will appear here." />
      )}
